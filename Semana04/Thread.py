...
# Urls dos sites para download das imagens
img_urls = [
...
t1 = time.perf_counter() # Variável que recebe o tempo de início do processamento
...
with concurrent.futures.ThreadPoolExecutor() as executor: # Implementando as threads como gerentes
    executor.map(download_image, img_urls) # Mapeando a thread para cada url e realizando o download de forma síncrona 


t2 = time.perf_counter() # Variável que recebe o tempo final de processamento
